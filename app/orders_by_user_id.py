...
def order_info_brief(userID):
    ...
    if request.method == 'POST':
        ...
        new_order = Order(userId=user.phone, storeName=order_dict['storeName'], createTime=order_dict['date'],mealFee=order_dict['mealFee'], ServiceFee=order_dict['serviceFee'],payPrice=order_dict['totalFee']-order_dict['offer'],totalPrice=order_dict['totalFee'], paymengtMethod=order_dict['paymentMethod'])
